...
stage_data = {
    ...
    'challenge-1': 1, 'challenge-2': 2, 'challenge-3': 1,
}
...
def to_tab(self, t):
    tabs = {
        'story': ((820, 103, 821, 104), (77, 55, 40)),
        'task': ((1000, 110, 1001, 111), (77, 55, 40)),
        'challenge': ((1190, 103, 1191, 104), (77, 55, 40)),
        'challenge-task': ((1190, 103, 1191, 104), (77, 55, 40)),
    }
    if image.compare_image(self, 'cm_activity-quest', 5, (705, 110), retry=5, cl=(705, 110)):
        tabs['task'] = ((1178, 112, 1179, 113), (77, 55, 40))
    tab = tabs[t]
...
def to_activity_page(self):
    pos = {
        ...
        'momo_talk_confirm-skip': (770, 516), 'normal_task_task-info': (1125, 142),
    ...
    if self.game_server == 'intl' and image.compare_image(self, 'cm_props', 3):
        self.click(60, 37)
        time.sleep(5)
...
def start(self):
    if self.game_server != 'intl':
        self.logger.error('国际服专属活动,其它区服不执行该任务')
        return None
    home.go_home(self)
    to_activity_page(self)
    start_exp(self)
...
def start_draw_card(self):
    ...
    while True:
        if color.check_rgb(self, (800, 600), (118, 220, 255)):
            image.detect(self, 'alive_card', (815, 568), cl=(815, 568))
